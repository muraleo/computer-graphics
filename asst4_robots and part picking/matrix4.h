...
inline Matrix4 transpose(const Matrix4& m)    //  return the transpose of m
{
  Matrix4 r(0);
  for (int i = 0; i < 4; ++i) {
    for (int j = 0; j < 4; ++j) {
...
inline Matrix4 normalMatrix(const Matrix4& m)  // return the inverse transpose of the linear factor ( which will store in the upper left of m)
{
  Matrix4 invm = inv(m);
...
inline Matrix4 transFact(const Matrix4& m)     //  return the translational factor of m
{
	// ==========================================
	// TODO: fill in your own implementation here
	// ==========================================

      // initial new matrix4 with contstructor with parameter
      Matrix4 r(0);// -----------------change----------------- 
...
inline Matrix4 linFact(const Matrix4& m)         // return the liner factor of m
{
	// ==========================================
	// TODO: fill in your own implementation here
	// ==========================================
