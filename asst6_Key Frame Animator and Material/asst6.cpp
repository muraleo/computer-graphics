...
static void initMaterials()	//------change
{
...
static void initScene() 
{
	...
	g_light1Node.reset(new SgRbtNode(RigTForm(g_light1)));	//------change
	g_light1Node->addChild(shared_ptr<MyShapeNode>(
				new MyShapeNode(g_sphere, g_lightMat)));

	g_light2Node.reset(new SgRbtNode(RigTForm(g_light2)));	//------change
	...
	g_world->addChild(g_light1Node);	//------change
	g_world->addChild(g_light2Node);	//------change
}
